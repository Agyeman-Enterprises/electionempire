...
namespace ElectionEmpire.Multiplayer.Network
{
    ...
    {
        private static readonly Dictionary<MessageType, Func<NetworkMessage>> MessageFactories = new Dictionary<MessageType, Func<NetworkMessage>>
        {
